...
namespace MD.ExpressionPredicateBuilder.Predicate
{
    ...
    public class SortCondition<TEntity>
    {
        ...
        private ParameterExpression _sortableParameterExpression;
        ...
        public Expression<Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>> GetIQueryableSortingExpression()
        {
            ...
            var funcLambdaExpression =
                Expression.Lambda<Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>>(sortExpression, _sortableParameterExpression);
        ...
        public Expression<Func<IEnumerable<TEntity>, IOrderedEnumerable<TEntity>>> GetIEnumerableSortingExpression()
        {
            ...
            if (sortExpression == null) return null;
            var funcLambdaExpression =
                Expression.Lambda<Func<IEnumerable<TEntity>, IOrderedEnumerable<TEntity>>>(sortExpression, _sortableParameterExpression);
            return funcLambdaExpression;
        }
        ...
        private Expression GetSortingExpression(Type destinationType, bool isIEnumerable = false)
        {
            ...
            _sortableParameterExpression = Expression.Parameter(isIEnumerable ? typeof(IEnumerable<TEntity>) : typeof(IQueryable<TEntity>), "f");
            ...
            foreach (var sortingItem in _sortItems)
            {
                ...
                if (resultExpression != null)
                    ...
                    methodCallExpression = Expression.Call(orderByMethodInfo, _sortableParameterExpression, lambdaExpression);
